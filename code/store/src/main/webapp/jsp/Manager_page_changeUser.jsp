...
<head>
  ...
  <link rel="stylesheet" href="../css/add personnel.css">
...
<%--          </li>--%>
  ...
  <section class="main-home">
    <div class="add-box">
      <form action="<%=application.getContextPath()%>/user/update" method="get">
        <%
        ...
        <ul class="container">
          <li>
            <label for="Serial number">uid:</label>
            <input type="text" id="Serial number" name="id" maxlength="18" value="<%=user.getUid()%>">
          </li>
          <li>
            <label for="user">管理员用户名:</label>
            <input type="text" id="user" name="userName" value="<%=user.getUserName()%>" maxlength="18">
          </li>
          <li>
            <label for="passward">管理员密码:</label>
            <input type="text" id="passward" name="userPwd" value="<%=user.getPassword()%>" maxlength="18">
          </li>
          <li>
            <label for="permission">权限:</label>
            <input type="text" id="permission" name="permission" value="<%=user.getPermission()%>" maxlength="18">
          </li>
          <%--          <li>--%>
          <%--            <label for="remark">备注:</label>--%>
          <%--            <textarea name="beizhu" id="remark" cols="26" rows="4"></textarea>--%>
          <%--          </li>--%>
        </ul>
        <div class="wrap">
