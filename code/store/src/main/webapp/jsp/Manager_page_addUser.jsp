...
<%--          </li>--%>
  ...
  <section class="main-home">
    <div class="add-box">
      <form action="<%=application.getContextPath()%>/user/add" method="get">
        <ul class="container">
          <li>
          ...
          <li>
            ...
            <input type="text" id="user" name="userName" maxlength="18">
          </li>
          <li>
            <label for="passward">管理员密码:</label>
            <input type="text" id="passward" name="userPwd" maxlength="18">
          </li>
          <li>
            <label for="permission">管理员权限:</label>
            <input type="text" id="permission" name="permission" maxlength="18" value="1">
          </li>
<%--          <li>--%>
